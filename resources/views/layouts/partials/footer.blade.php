<footer class="mt-auto bg-gradient-to-r from-[#FAF7F2] via-[#F8F4EE] to-[#F5F0E8] border-t shadow-lg">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <h3 class="text-slate-900 font-bold text-lg mb-4">Toko Bangunan Jaya Prana</h3>
            ...
            <div>
                <h3 class="text-slate-900 font-bold text-lg mb-4">Menu Cepat</h3>
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('dashboard') }}" class="text-slate-700 hover:text-slate-900 hover:font-semibold transition-colors text-sm flex items-center">
                    ...
                    <li>
                        <a href="{{ route('stokbarang') }}" class="text-slate-700 hover:text-slate-900 hover:font-semibold transition-colors text-sm flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('suppliers.index') }}" class="text-slate-700 hover:text-slate-900 hover:font-semibold transition-colors text-sm flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                <h3 class="text-slate-900 font-bold text-lg mb-4">Kontak Kami</h3>
                <ul class="space-y-2 text-sm text-slate-700">
                    <li class="flex items-start">
                        ...
                        <span>Jl. Pelita No. 2, Sarwodadi, Comal, Pemalang</span>
                    </li>
        ...
        <div class="border-t border-[#E8DFD3] mt-8 pt-6">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <p class="text-slate-600 text-xs mt-2 md:mt-0">
                    Version 1.0.0
                </p>
            </div>
        </div>
