    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form method="POST" action="{{ route('purchase-requests.update', $purchaseRequest) }}" class="bg-white rounded-xl shadow-lg border border-slate-200 p-8">
            ...
            @if($purchaseRequest->status === 'pending')
                ...
                <button type="button" onclick="confirmSave(this.closest('form'), 'purchase request')" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg transition-all duration-300">
