...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('barang-keluar.store') }}" method="POST" class="bg-white p-6 rounded-xl shadow-sm border">
        ...
        <div class="mt-6 flex items-center justify-end space-x-3">
            ...
            <button type="button" onclick="confirmCreate(this.closest('form'), 'Barang Keluar')" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-md shadow hover:bg-emerald-700 transition">Simpan</button>
        </div>
    </form>
</div>
