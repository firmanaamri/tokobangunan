...
<div class="min-h-screen bg-gradient-to-br from-[#FAF7F2] via-[#F8F4EE] to-[#FAF7F2] p-6">
    ...
    @enderror
            ...
            <div class="bg-slate-100 px-8 py-4 flex gap-4">
                <button type="button" onclick="confirmCreate(this.closest('form'), 'Transaksi Pembelian')" class="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-bold py-2 px-6 rounded-lg">Simpan</button>
