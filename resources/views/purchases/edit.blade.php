        ...
        <form action="{{ route('purchases.update', $purchase->id) }}" method="POST" class="bg-white rounded-xl shadow-lg overflow-hidden border border-slate-200">
            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_jatuh_tempo" value="{{ old('tanggal_jatuh_tempo', $purchase->tanggal_jatuh_tempo?->format('Y-m-d')) }}" class="w-full border-2 border-slate-300 rounded-lg px-4 py-2 focus:border-emerald-500 focus:outline-none @error('tanggal_jatuh_tempo') border-red-500 @enderror">
