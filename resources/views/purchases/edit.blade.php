    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('purchases.update', $purchase->id) }}" method="POST" class="bg-white rounded-xl shadow-lg overflow-hidden border border-slate-200">
            ...
            <div class="bg-slate-100 px-8 py-4 flex gap-4">
                <button type="button" onclick="confirmSave(this.closest('form'), 'transaksi pembelian')" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg transition-all duration-300">
