        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <a href="{{ route('purchase-requests.create') }}" class="w-fit sm:w-auto text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg shadow">+ Pembelian (Buat PR)</a>
