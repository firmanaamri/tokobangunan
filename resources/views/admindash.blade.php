        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p class="text-slate-600 mt-2">Status stok, penjualan, dan aktivitas terkini</p>
                </div>
                <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <a href="{{ route('purchase-requests.create') }}" class="w-full sm:w-auto text-center bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-semibold px-4 py-2 rounded-lg shadow">+ Pembelian (Buat PR)</a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div class="p-5 sm:p-6 rounded-xl shadow-lg border border-cyan-100 bg-gradient-to-br from-cyan-50 via-white to-cyan-50">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs uppercase font-semibold text-cyan-600">Mitra</p>
                            <h4 class="text-sm font-medium text-slate-600">Total Supplier Aktif</h4>
                        </div>
                        <div class="h-10 w-10 rounded-lg bg-cyan-100 text-cyan-600 flex items-center justify-center">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
                <div class="p-6 border-b border-slate-200 flex items-center justify-between">
                    ...
                    <div class="hidden md:block text-sm text-slate-500">Auto-generated dari pembelian & penjualan</div>
                </div>
