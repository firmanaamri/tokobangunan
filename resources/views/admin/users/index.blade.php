...
@section('content')
{{-- PERBAIKAN: Wrapper tambahan agar background abu-abu/putih mengisi penuh layar --}}
<div class="min-h-screen bg-white"> 
    ...
    <div class="max-w-7xl mx-auto p-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
                <h1 class="text-4xl font-bold text-slate-900">Manajemen User</h1>
                <p class="text-slate-600 mt-2">Kelola user yang dapat mengakses sistem</p>
            </div>
