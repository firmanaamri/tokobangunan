            ...
            <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        {{-- 5. Password (Dengan Fitur Show/Hide) --}}
                        <div class="col-span-1" x-data="{ show: false }">
                            ...
                            <div class="relative">
                                ...
                                {{-- Tombol Mata (Kanan) --}}
                                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-indigo-600 transition focus:outline-none">
                                    {{-- Mata Terbuka (Show) --}}
                        ...
                        {{-- 6. Konfirmasi Password (Dengan Fitur Show/Hide) --}}
                        <div class="col-span-1" x-data="{ show: false }">
